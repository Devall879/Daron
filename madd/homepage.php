...
<head>
  ...
  <!-- 
    - primary meta tag
  -->
  <title>Chesteph Schools-Little Things Turn To Big Things</title>
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="new.png" width="162" height="50" alt="EduWeb logo">
      </a>
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="contact_form.html" class="navbar-link" data-nav-link>Contact</a>
          </li>
      ...
      <div class="header-actions">
        ...
        <a href="Register.html" class="btn has-before">
          <span class="span">Enroll</span>
    ...
    <article>
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <h1 class="h1 section-title">
              Chesteph Schools <span class="span">Little</span> Things Turn To Big Things
            </h1>
      ...
      <section class="section category" aria-label="category">
        <div class="container">
          ...
          <h2 class="h2 section-title">
            Extra <span class="span">Classes</span> For Adequate Learning.
          </h2>

          <p class="section-text">
            In Chesteph Schools we provide adequate training for pupils/students.
          </p>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="category-card" style="--color: 170, 75%, 41%">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">Arts and Culture</a>
                </h3>
            ...
            <li>
              <div class="category-card" style="--color: 351, 83%, 61%">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">Phonetics and Oral English</a>
                </h3>
            ...
            <li>
              <div class="category-card" style="--color: 229, 75%, 58%">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">E-Craft</a>
                </h3>
            ...
            <li>
              <div class="category-card" style="--color: 42, 94%, 55%">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">Intense I.T Programs</a>
                </h3>
      ...
      <section class="section about" id="about" aria-label="about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            <h2 class="h2 section-title">
              Over 10 Years in <span class="span"> The Academic Field</span> Of Efficient Teaching and Learning
            </h2>
            ...
            <ul class="about-list">
              ...
              <li class="about-item">
                ...
                <span class="span">Qualified Teachers</span>
              </li>
      ...
      <section class="section course" id="courses" aria-label="course">
        <div class="container">
          ...
          <h2 class="h2 section-title">Kindly Register Below👇</h2>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="course-card">
                ...
                <figure class="card-banner img-holder" style="--width: 370; --height: 220;">
                  <img src="./assets/images/pexels-pixabay-459976.jpg" width="370" height="220" loading="lazy"
                    alt="Chesteph International Nursery And Primary School" class="img-cover">
                </figure>

                <div class="abs-badge">
                  <ion-icon name="time-outline" aria-hidden="true"></ion-icon>

                  <span class="span">CreChe/DayCare</span>
                </div>

                <div class="card-content">

                  <span class="badge">Creche/DayCare</span>

                  <h3 class="h3">
                    <a href="#" class="card-title">Chesteph International Nursery And Primary School</a>
                  </h3>
                  ...
                  <data class="price" value="29">--</data>
            ...
            <li>
              <div class="course-card">
                ...
                <figure class="card-banner img-holder" style="--width: 370; --height: 220;">
                  <img src="./assets/images/primary.jpg" width="370" height="220" loading="lazy"
                ...
                <div class="abs-badge">
                  ...
                  <span class="span">Pre-Nursery---Basic 5</span>
                </div>
                ...
                <div class="card-content">
                  ...
                  <data class="price" value="49">--</data>
            ...
            <li>
              <div class="course-card">
                ...
                <div class="abs-badge">
                  ...
                  <span class="span">Jss1-Sss3</span>
                </div>
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="#" class="card-title">Chesteph International Secondary School</a>
                  </h3>
                  ...
                  <data class="price" value="35">--</data>
      ...
      <section class="section blog has-bg-image" id="blog" aria-label="blog"
        ...
        <div class="container">
          ...
          <h2 class="h2 section-title">Get News With Chesteph</h2>
  ...
  <footer class="footer" style="background-image: url('./assets/images/footer-bg.png')">
    ...
    <div class="footer-top section">
      <div class="container grid-list">
        ...
        <div class="footer-brand">
          ...
          <a href="#" class="logo">
            <img src="new.png" width="162" height="50" alt="Chesteph">
          </a>
          ...
          <div class="wrapper">
            ...
            <address class="address">Ihechiowa Street And Opposite ICAPS, Federal Housing Estate, Trans-Egbu</address>
          </div>

          <div class="wrapper">
            <span class="span">Call:</span>

            <a href="tel:+2348036395699" class="footer-link">+234 803 6395 699</a>
          </div>

          <div class="wrapper">
            <span class="span">Email:</span>

            <a href="mailto:chesteph11@gmail.com" class="footer-link">chesteph11@gmail.com</a>
          </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          Copyright 2024 All Rights Reserved by <a href="#" class="copyright-link">codewithsadee</a>
        </p>
